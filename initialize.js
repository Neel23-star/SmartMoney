...
app.listen(PORT, () => {
  ...
  'backend/mockAI.js': `function analyzeRequest(requestData) {
  const {
    employee_name,
    employee_id,
    request_type,
...
module.exports = { analyzeRequest };`,
  ...
  'backend/routes/requests.js': `const express = require('express');
...
export default function App() {
  ...
  'frontend/src/components/Sidebar.jsx': `import { NavLink } from 'react-router-dom'
